    ...
    <div className="App">
      ...
      <section id="inicio" className="hero-section">
        <div className="hero-content">
          ...
          <img src="https://via.placeholder.com/600x300/0a66c2/ffffff?text=Innovación+y+Tecnología" alt="GIIT Research" className="hero-image" />
        ...
        <div className="container">
          ...
          <div className="about-content">
            ...
            <div className="about-image">
              <img src="https://via.placeholder.com/500x400/f5f5f5/0a66c2?text=Nuestro+Equipo" alt="Equipo GIIT" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="projects-grid">
            <div className="project-card">
              <img src="https://via.placeholder.com/350x200/0a66c2/ffffff?text=Smart+City" alt="Proyecto Smart City" />
            ...
            <div className="project-card">
              <img src="https://via.placeholder.com/350x200/28a745/ffffff?text=AI+Healthcare" alt="Proyecto AI Healthcare" />
              <div className="project-content">
            ...
            <div className="project-card">
              <img src="https://via.placeholder.com/350x200/ffc107/ffffff?text=Blockchain" alt="Proyecto Blockchain" />
              <div className="project-content">
        ...
        <div className="container">
          ...
          <div className="members-grid">
            <div className="member-card">
              <img src="https://via.placeholder.com/200x200/0a66c2/ffffff?text=MG" alt="María García" />
            ...
            <div className="member-card">
              <img src="https://via.placeholder.com/200x200/28a745/ffffff?text=AL" alt="Antonio López" />
            ...
            <div className="member-card">
              <img src="https://via.placeholder.com/200x200/ffc107/ffffff?text=JM" alt="José Martínez" />
            ...
            <div className="member-card">
              <img src="https://via.placeholder.com/200x200/dc3545/ffffff?text=CR" alt="Carmen Rodríguez" />
            ...
            <div className="member-card">
              <img src="https://via.placeholder.com/200x200/6f42c1/ffffff?text=LF" alt="Luis Fernández" />
            ...
            <div className="member-card">
              <img src="https://via.placeholder.com/200x200/fd7e14/ffffff?text=PS" alt="Patricia Sánchez" />
